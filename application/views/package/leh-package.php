	...
	<section>
		<div class="rows inner_banner inner_banner_4">
			<div class="container">
				<h2><span>LADAKH 6 NIGHTS / 7 DAYS -</span> Ladakh</h2>
				<!-- <ul>
					...
					<div class="tour_head1 l-info-pack-days days">
						...
						<ul>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 1</span> Delhi - Leh : Airport Pickup </h4>
								<p>Arrive at Leh airport, meet and greet by our representative and transfer to your reserved accommodation. Spend the rest of the day acclimatizing to the climate of Ladakh. Overnight in Leh</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 2</span> Leh - Sham Valley - Leh</h4>
								<p>After breakfast proceed for an excursion to Sham Valley, visit Likir, Alchi Monastery, Sangam (Confluence of Zanskar & Indus Rivers, Magnetic Hill, Pathar Sahib Gurudwara and Hall of Fame museum.  Overnight in Leh</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 3</span> Leh - Nubra Valley (128 Kms | 4-5 hrs approx)</h4>
								<p>After Breakfast drive to Nubra Valley via Khardungla (Highest Motorable road in the world, 18,380 ft). You can take short breaks at roadside cafes and scenic points for photography. On arrival check in to the hotel/camp. Post lunch, enjoy a camel safari (double humped camel which are found only in Ladakh & Mongolia) at the Sand Dunes between Deskit & Hundur Village. Overnight in  Nubra Valley</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 4</span> Nubra - Pangong Lake via Shyok river road (150 Kms | 6-7 Hrs approx)</h4>
								<p>After Breakfast leave for Pangong Lake 14,500 ft, drive of 6 – 7 Hrs. Arrival at Camp, Later free time at Leisure and enjoy the color changing lake and the sun set on the banks of lake. Overnight in Pangong Lake.</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 5</span> Pangong Lake – Leh</h4>
							...
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 7</span> Leh Airport Drop (4 Kms | 15 minutes Approx)</h4>
