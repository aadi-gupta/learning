	<style type="text/css">
	.inner_banner_4 {
    background: url(../../../assets/images/pack/1350x500/North-east/North_East4.jpg) no-repeat center center;
	...
	<section>
		<div class="rows inner_banner inner_banner_4">
			<div class="container">
				<h2><span>LOST KINGDOM  -</span> Gangtok,Pelling</h2>
			...
			<div class="container">
				<div class="banner_book_1">
					<ul>
						...
						<li class="dl2">Price : Starting from ₹17,300</li>
		...
		<div class="rows inn-page-bg com-colo">
			<div class="container inn-page-con-bg tb-space">
				<div class="col-md-9">
					<!--====== TOUR TITLE ==========-->
					<div class="tour_head">
						<h2>LOST KINGDOM (Gangtok 2N - Pelling 2N)<span class="tour_star"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star-half-o" aria-hidden="true"></i></span><span class="tour_rat">4.5</span></h2> </div>
					<!--====== TOUR DESCRIPTION ==========-->
					...
					<div class="tour_head1 l-info-pack-days days">
						...
						<ul>
							...
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 3</span> Gangtok – Pelling (150 kms / 5 hrs) via Chardham</h4>
								<p>After breakfast start for Pelling (6,300 ft.). Enroute visit Temi Tea Garden, Samdruptse & Siddheshwar Dham (Chardham) in Namchi. On arrival check-in to your hotel. Overnight stay at Pelling.</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 4</span> Pelling Sightseeing</h4>
								<p>After breakfast start for full day sightseeing. 1st Half tour - Darap village, Rimbi water Falls, Khecheopalri Lake & Khangchendzongha waterfalls. In afternoon start for 2nd Half tour - Pemayangtse Monastery, Rabdantse Ruins, New Helipad Ground. Overnight stay at Pelling.</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 4</span> Pelling – NJP Rly Station / IXB Airport (136 kms / 5 hrs)</h4>
								<p>After breakfast Check-out from hotel in time and take the departure transfer to NJP Railway Station / IXB Airport for your onward journey.</p>
							</li>
						</ul>
					</div>
					<div>
						<div class="dir-rat">
							...
							<div class="dir-rat-inn dir-rat-review">
								<div class="row">
									<div class="col-md-3 dir-rat-left"> <img src="../../../assets/images/reviewer/1.jpg" alt="">
										<p>Rohit Chauhan <span>25thth Dec, 2017</span> </p>
									</div>
							...
							<div class="dir-rat-inn dir-rat-review">
								<div class="row">
									<div class="col-md-3 dir-rat-left"> <img src="../../../assets/images/reviewer/1.jpg" alt="">
										<p>Sonu jangid <span>25thth Dec, 2017</span> </p>
									</div>
									<div class="col-md-9 dir-rat-right">
										<div class="dir-rat-star"> <i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star-o" aria-hidden="true"></i> </div>
										<p>We had a very pleasant trip and didn’t face any hassles. Our trip to Gangtok and Darjeeling happened just the way we wanted it to be and that became possible because of beyondstay team. They also had deep understanding of our requirements and customised the itinerary accordingly.</p>
