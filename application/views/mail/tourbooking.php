<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $mail_to = "aditya.maiet@gmail.com";
        ...
        $content .= "Email: $email\n\n";
        $content .= "City: $city\n";
		$content .= "Package type: $package\n";
		$content .= "Arrival date: $arrival\n";
		$content .= "Departure date: $departure\n";
        ...
        if ($success) {
            ...
            echo "Thank you for arranging a wonderful trip for us! Our team will contact you shortly!";
        } else {
