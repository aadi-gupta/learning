<section>		
	...
	<section>
		<div class="rows inner_banner inner_banner_4">
			<div class="container">
				<h2><span>HIMALAYAN TRANQUILITY -</span> Gangtok, Darjeeling</h2>
				<!-- <ul>
		...
		<div class="rows banner_book" id="inner-page-title">
			<div class="container">
				<div class="banner_book_1">
					<ul>
						<li class="dl1">Location : Gangtok,Darjeeling</li>
						<li class="dl2">Price : Starting from ₹17,000</li>
						<li class="dl3">Duration : 4 Nights/ 5 Days</li>
		...
		<div class="rows inn-page-bg com-colo">
			<div class="container inn-page-con-bg tb-space">
				<div class="col-md-9">
					<!--====== TOUR TITLE ==========-->
					<div class="tour_head">
						<h2>HIMALAYAN TRANQUILITY (Gangtok 2N - Darjeeling 2N)<span class="tour_star"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star-half-o" aria-hidden="true"></i></span><span class="tour_rat">4.5</span></h2> </div>
					<!--====== TOUR DESCRIPTION ==========-->
					...
					<div class="tour_head1 l-info-pack-days days">
						...
						<ul>
							...
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 3</span> Gangtok Local Sightseeing – Darjeeling (100 kms / 4 hrs)</h4>
							...
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 4</span> Darjeeling Sightseeing</h4>
							...
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 5</span> Darjeeling – NJP Rly Station / IXB Airport (75 kms / 3 hrs)</h4>
				...
				<div class="col-md-3 tour_r">
					...
					<div class="tour_right tour_rela tour-ri-com">
						...
						<div class="tour_rela_1"> <img src="../../../assets/images/related1.png" alt="" />
							...
							<p>If the idea of travelling to North East hamlets, brings to your mind a vivid picture of the colonial hill station, </p> <a href="#" class="link-btn">View this Package</a> </div>
