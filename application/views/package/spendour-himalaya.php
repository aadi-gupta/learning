	...
	<style type="text/css">
	.inner_banner_4 {
    background: url(../../../assets/images/pack/1350x500/North-east/North_East6.jpg) no-repeat center center;
	...
	<section>
		<div class="rows inner_banner inner_banner_4">
			<div class="container">
				<h2><span>SPLENDOUR HIMALAYA -</span> Gangtok</h2>
		...
		<div class="rows banner_book" id="inner-page-title">
			<div class="container">
				<div class="banner_book_1">
					<ul>
						<li class="dl1">Location : Gangtok</li>
						<li class="dl2">Price : Starting from ₹11,900</li>
		...
		<div class="rows inn-page-bg com-colo">
			<div class="container inn-page-con-bg tb-space">
				<div class="col-md-9">
					<!--====== TOUR TITLE ==========-->
					<div class="tour_head">
						<h2>SPLENDOUR HIMALAYA (Gangtok 3N)<span class="tour_star"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star-half-o" aria-hidden="true"></i></span><span class="tour_rat">4.5</span></h2> </div>
					<!--====== TOUR DESCRIPTION ==========-->
					...
					<div class="tour_head1 tout-map map-container">
						<h3>Location</h3>
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d56706.180507194375!2d88.5853695769649!3d27.340207557071462!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39e6a56a5805eafb%3A0x73d6132c501c8f20!2sGangtok%2C+Sikkim!5e0!3m2!1sen!2sin!4v1550143066488" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
					</div>
					...
					<div class="tour_head1 l-info-pack-days days">
						...
						<ul>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 1</span> NJP Rly Station / IXB Airport – Gangtok (120 kms / 5 hrs)</h4>
								<p>Meet & Greet on arrival at NJP Railway Station / IXB Airport & transfer to Gangtok (5,500 ft.). On arrival Check-in to hotel & rest of the day at leisure. Overnight stay at Gangtok.</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 2</span> Excursion to Tsomgo Lake & Baba Mandir</h4>
								<p>After breakfast start for an excursion to Tsomgo Lake (12,400 ft.) & Baba Mandir (13,200 ft.) which is 55 kms one way from Gangtok city. Overnight stay at Gangtok.</p>
								<p>(In case of Land slide or any other reason Tsomgo Lake is closed we will provide alternate sightseeing.)</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 3</span> Gangtok Local Sightseeing</h4>
								<p>Start for a Full day city tour covering Tashi view point, Ganesh Tok, Hanuman Tok, Flower show, Cottage Industry and Handicraft Centre, Institute of Tibetology, Dro-dul Chorten, Enchey Monastery & Banjakhri Falls (maximum 6 hours). Overnight stay at Gangtok.</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 4</span> Gangtok – NJP Rly Station / IXB airport (120 kms / 5 hrs)</h4>
								<p>After breakfast Check-out from hotel and take the departure transfer to NJP Railway Station / IXB airport for your onward journey.</p>
							</li>
						</ul>
					</div>
					<div>
							...
							<div class="dir-rat-inn dir-rat-review">
								<div class="row">
									<div class="col-md-3 dir-rat-left"> <img src="../../../assets/images/reviewer/4.jpeg" alt="">
										<p>Charag Sharma <span>16th Feb, 2018</span> </p>
									</div>
									<div class="col-md-9 dir-rat-right">
										...
										<p>My family trip to the northeast was everything that I wanted and more. Needless to say, northeast India was amazingly beautiful. Beyondstay made sure everything was perfect when it came to coordination and package and I really have to thank them for their efforts in ensuring that we really enjoy our family holiday.</p>
							...
							<div class="dir-rat-inn dir-rat-review">
								<div class="row">
									<div class="col-md-3 dir-rat-left"> <img src="../../../assets/images/reviewer/1.jpg" alt="">
										<p>Riya Chadda<span>25thth Dec, 2017</span> </p>
									</div>
									<div class="col-md-9 dir-rat-right">
										<div class="dir-rat-star"> <i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star-o" aria-hidden="true"></i> </div>
										<p>For people traveling solo, I would recommend you book a package with beyondstay.com and travel hassle-free. The panoramic perfection of the snow capped mountain, the fascinating scent of flower bedecked meadows, vibrant culture and joyous festival is something that allows me to witness the places peacefully, and that is exactly how it happened on my trip to Sikkim. But it was peaceful because of a reason, beyoundstay.com for they gave me a hassle-free holiday because of which I could click amazing pictures in peace, explore new places, and interact with all kinds of amazing people.</p>
