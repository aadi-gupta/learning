	<style type="text/css">
	.inner_banner_4 {
    background: url(../../../assets/images/pack/1350x500/North-east/North_East1.jpg) no-repeat center center;
	...
	<section>
		<div class="rows inner_banner inner_banner_4">
			<div class="container">
				<h2><span>GREEN DOOARS -</span> Jaldapara 1N - Lataguri 2N</h2>
		...
		<div class="rows banner_book" id="inner-page-title">
			<div class="container">
				<div class="banner_book_1">
					<ul>
						<li class="dl1">Location : Jaldapara,Lataguri</li>
						<li class="dl2">Price : Starting from ₹13,200</li>
		...
		<div class="rows inn-page-bg com-colo">
			<div class="container inn-page-con-bg tb-space">
				<div class="col-md-9">
					<!--====== TOUR TITLE ==========-->
					<div class="tour_head">
						<h2>GREEN DOOARS (Jaldapara 1N-Lataguri 2N)<span class="tour_star"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star-half-o" aria-hidden="true"></i></span><span class="tour_rat">4.5</span></h2> </div>
					<!--====== TOUR DESCRIPTION ==========-->
					...
					<div class="tour_head1 tout-map map-container">
						<h3>Location</h3>
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28512.214492941992!2d88.74412518565151!3d26.711590425719223!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39e475ddf18d4669%3A0x1946af3bd2cf3173!2sLataguri%2C+West+Bengal+735219!5e0!3m2!1sen!2sin!4v1550143651645" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
					</div>
					<!--====== DURATION ==========-->
					<div class="tour_head1 l-info-pack-days days">
						...
						<ul>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 1</span> NJP Rly Station / IXB Airport – Jaldapara (120 kms / 4 hrs)</h4>
								<p>Meet & Greet on arrival at NJP Railway Station / IXB Airport & transfer to Jaldapara. On arrival Check-in to hotel & rest of the day at leisure. Overnight stay at Jaldapara.</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 2</span> Jaldapara Wild Life Sanctuary – Lataguri / Chalsa (80 kms / 2 hrs)</h4>
								<p>Early morning at 06:00 hrs visit Jaldapara Wild Life Sanctuary on back of the Elephant / by Jeep (as per availability & on direct payment basis). Back to hotel for breakfast. Transfer to Lataguri / Chalsa. Overnight stay at Lataguri / Chalsa.</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 3</span> Gorumara National Park + Local Sightseeing</h4>
								<p>Early morning at 06:00 hrs visit Gorumara National Park (Watch Tower visit on direct payment basis) by Jeep. Back to hotel for breakfast. After breakfast visit Samsing, Suntalekhola & Murti River side. In afternoon visit another Watch Tower by Jeep. Overnight stay at Lataguri / Chalsa.</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 4</span> Lataguri / Chalsa – NJP Rly Station / IXB airport (90 kms / 3 hrs) </h4>
								<p>After breakfast Check-out from hotel and take the departure transfers to NJP Railway Station / IXB airport for your onward journey.</p>
							</li>
						</ul>
					</div>
					<div>
							...
							<div class="dir-rat-inn dir-rat-review">
								<div class="row">
									<div class="col-md-3 dir-rat-left"> <img src="../../../assets/images/reviewer/4.jpeg" alt="">
										<p>Ravi tyagi <span>29th Nov, 2018</span> </p>
									</div>
							...
							<div class="dir-rat-inn dir-rat-review">
								<div class="row">
									<div class="col-md-3 dir-rat-left"> <img src="../../../assets/images/reviewer/1.jpg" alt="">
										<p>Charu Gupta <span>25thth Dec, 2017</span> </p>
									</div>
									<div class="col-md-9 dir-rat-right">
										<div class="dir-rat-star"> <i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star-o" aria-hidden="true"></i> </div>
