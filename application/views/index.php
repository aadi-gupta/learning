            ...
            <div class="container">
                <div class="row">
                    <div class="tourz-search-1">
                        <h1>Experience Beyond Stay !!</h1>
                        <p>Experience the various exciting tour and travel packages and Make hotel reservations, find vacation packages, search villas and events</p>
                        ...
                        <div class="tourz-hom-ser">
                            <ul>
                                <li>
                                    <a href="booking-tour-package.html" class="waves-effect waves-light btn-large tourz-pop-ser-btn wow fadeInUp" data-wow-duration="0.5s"><img src="../../../assets/images/icon/2.png" alt=""> Packages</a>
                                </li>
                                <li>
                                    <a href="#" class="waves-effect waves-light btn-large tourz-pop-ser-btn wow fadeInUp" data-wow-duration="1.5s"><img src="../../../assets/images/icon/31.png" alt=""> Gateways</a>
                                </li>
                                <li>
                                    <a href="booking-hotel.html" class="waves-effect waves-light btn-large tourz-pop-ser-btn wow fadeInUp" data-wow-duration="2s"><img src="../../../assets/images/icon/1.png" alt=""> Hotels</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="rows pad-bot-redu tb-space">
            <div class="container">
                ...
                <div class="spe-title">
                    ...
                    <p>India's leading tour packages listed website, Select over 25,000 packages pan india.</p>
                </div>
                <div>
                    <!-- TOUR PLACE 1 -->
        ...
        <div class="rows tb-space pad-top-o pad-bot-redu">
            <div class="container">
                ...
                <div class="spe-title">
                    ...
                    <p>Over 4,000 destinations PAN India. Choose between top locations and enjoy your holidays with distinctive experience.</p>
                </div>
                <!-- CITY -->
                <div class="col-md-6">
    ...
    <section>
        <div class="rows tb-space pad-top-o pad-bot-redu">
            <div class="container">
                <!-- TITLE & DESCRIPTION -->
                <div class="spe-title">
                    <h2>Package <span>bookings open now! </span> </h2>
                    <div class="title-line">
                        <div class="tl-1"></div>
                        <div class="tl-2"></div>
                        <div class="tl-3"></div>
    ...
    <section>
        <div class="offer">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="offer-l"> <span class="ol-1"></span> <span class="ol-2"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></span> <span class="ol-4">Taylor made packages</span><span class="ol-3"></span> <span class="ol-5">₹9999/-</span>
                            <ul>
                                <li class="wow fadeInUp" data-wow-duration="0.5s">
                                    <a href="#!" class="waves-effect waves-light btn-large offer-btn"><img src="../../../assets/images/icon/dis1.png" alt="">
									</a><span>Free WiFi</span>
                                </li>
                                <li class="wow fadeInUp" data-wow-duration="0.7s">
                                    <a href="#!" class="waves-effect waves-light btn-large offer-btn"><img src="../../../assets/images/icon/dis2.png" alt=""> </a><span>Breakfast</span>
                                </li>
                                <li class="wow fadeInUp" data-wow-duration="0.9s">
                                    <a href="#!" class="waves-effect waves-light btn-large offer-btn"><img src="../../../assets/images/icon/dis3.png" alt=""> </a><span>Pool</span>
                                </li>
                                <li class="wow fadeInUp" data-wow-duration="1.1s">
                                    <a href="#!" class="waves-effect waves-light btn-large offer-btn"><img src="../../../assets/images/icon/dis4.png" alt=""> </a><span>Television</span>
                                </li>
                                <li class="wow fadeInUp" data-wow-duration="1.3s">
                                    <a href="#!" class="waves-effect waves-light btn-large offer-btn"><img src="../../../assets/images/icon/dis5.png" alt=""> </a><span>GYM</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="offer-r">
                            ...
                            <div class="or-2"> <span class="or-21">Get</span> <span class="or-22">70%</span> <span class="or-23">Off</span> <span class="or-24">use code: BEYONDSTAY999</span> <span class="or-25"></span> </div>
                        </div>
                    </div>
                </div>
            </div>
