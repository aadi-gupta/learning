	<style type="text/css">
	.inner_banner_4 {
    background: url(../../../assets/images/pack/1350x500/North-east/North_East2.jpg) no-repeat center center;
	...
	<section>
		<div class="rows inner_banner inner_banner_4">
			<div class="container">
				<h2><span>HEAVEN ON HILLS -</span> Darjeeling</h2>
				<!-- <ul>
			...
			<div class="container">
				<div class="banner_book_1">
					<ul>
						...
						<li class="dl2">Price : Starting from ₹12,700</li>
				...
				<div class="col-md-9">
					...
					<div class="tour_head1 l-info-pack-days days">
						...
						<ul>
							...
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 3</span> Darjeeling – Kalimpong (57 kms / 2 ½ hrs) Sightseeing</h4>
								<p>After Breakfast transfer to Kalimpong (3,950 ft.). On arrival check-in to your hotel. Afternoon enjoy half day tour of Kalimpong Visiting Mangal Dham, Deolo Hill, Dr. Graham’s Home, Golf Garden, Durpin Dara Hills & Pine View Nursery. Overnight stay at Kalimpong.</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 4</span> Kalimpong – NJP Rly Station / IXB Airport (75 kms / 3 hrs)</h4>
								<p>After breakfast Check-out from hotel on time and take the departure transfer to NJP Railway Station / IXB airport for your onward journey.</p>
							</li>
						</ul>
					</div>
					<div>
							...
							<div class="dir-rat-inn dir-rat-review">
								<div class="row">
									<div class="col-md-3 dir-rat-left"> <img src="../../../assets/images/reviewer/3.jpeg" alt="">
										<p>Smriti Chopda <span>19th Jun, 2018</span> </p>
									</div>
