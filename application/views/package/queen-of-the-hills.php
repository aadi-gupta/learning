	...
	<section>
		<div class="rows inner_banner inner_banner_4">
			<div class="container">
				<h2><span>Queen of the hills -</span> Darjeeling</h2>
				<!-- <ul>
					...
					<div class="tour_head1 l-info-pack-days days">
						...
						<ul>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 1</span> NJP Rly Station / IXB Airport – Darjeeling (75 kms / 3 hrs)</h4>
								<p>Meet & Greet on arrival at NJP Railway Station / IXB Airport & transfer to Darjeeling (6,950 ft.). On arrival Check-in to hotel & rest of the day at leisure. Overnight stay at Darjeeling.</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 2</span> Darjeeling Sightseeing</h4>
							...
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 3</span> Mirik Excursion (49 kms / 2 hrs one way)</h4>
								<p>After breakfast full day excursion trip to Mirik Lake (4,902 ft.) via Indo-Nepal Border (Extra vehicle charges will be applicable for Nepal Border to Pasupati Market). Mirik is famous for its man-made Sumendu Lake, Cardamom plantations and Tea Estates. (One can do Boating on direct payment basis in lake). In evening return to the hotel. Overnight stay at Darjeeling.</p>
							</li>
							<li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								<h4><span>Day : 4</span> Darjeeling – NJP Rly Station / IXB Airport (75 kms / 3 hrs)</h4>
